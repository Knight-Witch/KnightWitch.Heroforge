...
(function () {
  ...
  const VERSION = "2.0.2";
  const BUILD = "2.0.2-issue-24-texture-restore";
  const SCRIPT_NAME = "Witch Dock v2.0.2";
  const DISPLAY_NAME = "WITCH DOCK";
  const CHANNEL_BRANCH = "Witch_Scripts";
  const PAYLOAD_REF = "fa442b99a7376aa31882f66fd20ae8cded32fe67";
