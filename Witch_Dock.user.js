...
(function () {
  ...
  const VERSION = "2.0.1";
  const BUILD = "2.0.1-issue-20-booth-json";
  const SCRIPT_NAME = "Witch Dock v2.0.1";
  const DISPLAY_NAME = "WITCH DOCK";
  const CHANNEL_BRANCH = "Witch_Scripts";
  const PAYLOAD_REF = "f773cd9607d12a4479e31951973f288fa282543a";
