...
Issue #58 — Bundle Polymorph display fonts for Witch Dock headers — resumes as the active Dev task. Its staged Polymorph Regular/Bold assets and display typography remain Dev-only; next gate is live font-load verification followed by Amanda's visual approval.
...
- #58 is active and remains Dev-only pending live font-load verification and Amanda's typography visual approval.
