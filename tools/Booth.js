(function () {
  ...
  function onUserBoothToggle(v, options) {
    ...
    if (state.userBoothOn) {
      try {
        const runtimeBootstrap = UW.KW_WD_BOOTH_BOOTSTRAP;
        if (runtimeBootstrap && typeof runtimeBootstrap.requestSession === 'function') {
          runtimeBootstrap.requestSession(opts.source === 'default' ? 'booth-default-session' : 'booth-user-session');
        }
      } catch {}
    }
